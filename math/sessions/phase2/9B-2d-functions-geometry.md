...
![The five forms of a line]({{graph:9b-01-line-forms}})
...
![Converting between line forms]({{graph:9b-02-step-line-forms}})
...
![Parallel and perpendicular lines]({{graph:9b-03-parallel-perpendicular}})
...
![Angle between two lines]({{graph:9b-04-angle-between-lines}})
...
![Midpoint and section formula]({{graph:9b-05-midpoint-division}})
...
![Point-to-line distance derivation]({{graph:9b-06-point-line-distance}})
...
![Step-by-step distance calculation]({{graph:9b-07-step-distance-line}})
...
![Distance between parallel lines]({{graph:9b-08-two-lines-distance}})
...
![Point-to-circle distance]({{graph:9b-09-point-circle-distance}})
...
![Tangent lines from a point to a circle]({{graph:9b-10-tangent-lines-circle}})
...
![Circle — center, radius, and completing the square]({{graph:9b-11-circle-details}})
...
![Building a circle step by step]({{graph:9b-12-step-conic-circle}})
...
![Ellipse with foci, vertices, and derivation]({{graph:9b-13-ellipse-details}})
...
![Building an ellipse step by step]({{graph:9b-14-step-conic-ellipse}})
...
![Parabola — focus, directrix, and derivation of p]({{graph:9b-15-parabola-details}})
...
![Building a parabola step by step]({{graph:9b-16-step-conic-parabola}})
...
![Hyperbola — foci, vertices, asymptotes, and derivation]({{graph:9b-17-hyperbola-details}})
...
![Building a hyperbola step by step]({{graph:9b-18-step-conic-hyperbola}})
...
![Conic identification flowchart]({{graph:9b-19-conic-identification}})
...
![Four conics side by side]({{graph:9b-20-conic-comparison}})
...
![Parametric curves — line, circle, ellipse, cycloid]({{graph:9b-21-parametric-motion}})
...
![Building parametric curves step by step]({{graph:9b-22-step-parametric}})
...
![Triangle area from coordinates — the shoelace formula]({{graph:9b-23-triangle-area}})
...
![Polygon area — the shoelace formula]({{graph:9b-24-area-polygon}})
...
![Point reflection across a line]({{graph:9b-25-point-reflection}})
